...
public class Game {
    ...
    private void printWelcome() {
        System.out.println();
        System.out.println(
                "Welcome to the Escape the labryinth. The aim of this game to find a way out whilst evading the minotaur.");
    ...
    private void drop(Command command) {
        ...
        /**
         * // If itemToDrop was found, remove it from itemsHeld and add it to the
         * current room
         * if (itemToDrop != null) {
